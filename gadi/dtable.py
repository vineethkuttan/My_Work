...
def diesel_price():
    today = date.today()
    wiki = "https://www.sify.com/finance/today-diesel-price/"
    page = urllib.request.urlopen(wiki)
    k = f"""
    <!DOCTYPE html>
    <html>
      <head>
        <title>Diesel Price</title>
        <meta charset="utf-8">
    ...
    <nav class="navbar navbar-dark bg-dark">
        ...
        <h3 style="background-color:#b3b3b3;">DIESEL PRICE OF {today} :</h3>
    ...
    path = 'D:\\Gadi_By_FlasK\\Gadi_By_FlasK\\templates\\dieselprice.html'
